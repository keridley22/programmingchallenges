...
def question_7_and_8(accounts, currents):
    ...
    accounts.to_csv('accounts_enhanced.csv')
    return accounts
...
accounts_enhanced=question_7_and_8(accounts, currents)
#print(accounts_enhanced.head(5))

question_9(accounts_enhanced, currents)
